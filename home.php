...
<html>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#PERFECT SOLUTIONS">PERFECT SOLUTIONS</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#Aboute us">Aboute us</a>
        </li>
...
<center>
<img src="image/cam logo.png" class="img-fluid" alt="logo">
</center>
...
Back-end devs take care of less visible tasks that ensure the website runs smoothly, such as managing the website’s hosting services, database, and applications. Back-end devs might need to engineer solution to server issues by using additional server-side languages such as  PHP.
</p>
<h2 >
    Contacts
  </h2>
...
<a id="Aboute us">
<h2 >Aboute us</h2>
<P>In my companey i use to creat web site good deasine web page and full stack developer  i use to redy to help for as a free lancing for any compay </P>
</a>
